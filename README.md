...
### Justification on why I chose the artefact
I included this screenshot because Act Utilitarianism initially resonated with my own approach to everyday problems, even though I did not think this "rule of thumb" had a formal name. Moreover, the lecturer's warning about the dangers of relying on unverified estimates made me reflect on my own cognitive biases: being analytical is useful, but if the data we input into our "utilitarian calculus" is flawed, as even the most logical decisions can lead to catastrophic consequences. I have definitely experienced this before, just on a minor scale within my family life, when I did not take into account all members' opinions. I think I gained a vital takeaway for my future career in ICT, where data reliability is everything.
